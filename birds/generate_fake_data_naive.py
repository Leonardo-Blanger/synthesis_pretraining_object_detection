...
parser.add_argument('--output_dir', default='../data/birds_fake_naive')
...
parser.add_argument('--fake_objects_dir', default='../data/fake_birds_DMGAN', type=str,
...
fake_image_paths = []
for subdir in os.listdir(FAKE_OBJECTS_DIR):
    subdir = os.path.join(FAKE_OBJECTS_DIR, subdir)
    fake_image_paths += [os.path.join(subdir, img_file)
